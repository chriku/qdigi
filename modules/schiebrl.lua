...
function paintEvent(painter,color)
  ...
  painter:drawText("1R",1,1.5,1.4,1)
...
return {width=3,height=7,name="Schieberegister",pins={{0,1,"INPUT"},{0,2,"INPUT"},{0,4,"INPUT"},{4,4,"OUTPUT"},{4,5,"OUTPUT"},{4,6,"OUTPUT"},{4,7,"OUTPUT"}},category="flip",description="Schieberegister"}
