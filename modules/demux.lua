function paintEvent(painter)
  ...
  painter:drawText("DeMUX",0.5,0.5,3,4)
...
return {width=3,height=4,name="DeMUX",pins={{0,1,"INPUT"},{0,2,"INPUT"},{0,4,"INPUT"},{4,1,"OUTPUT"},{4,2,"OUTPUT"},{4,3,"OUTPUT"},{4,4,"OUTPUT"}},category="base",alt={"DeMUX-FlipFlop"}}
