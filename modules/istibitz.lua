...
function makeState()
  ...
  nums={4,5,6,7,8,9,10,11,12,32,32,32,32,32,32,32}
  nums[0]=3
  for i=0,#nums do
    if nums[i]==num then
      state=i
...
return {width=2,height=4,name="Reverse-Stibitz",pins={{3,1,"OUTPUT"},{3,2,"OUTPUT"},{3,3,"OUTPUT"},{3,4,"OUTPUT"},{0,1,"INPUT"},{0,2,"INPUT"},{0,3,"INPUT"},{0,4,"INPUT"}},category="coder"}
